        ...
        <div className="flex flex-col lg:flex-row gap-[90px] items-center justify-between">
          ...
          <div className="">
            <div className="lg:w-[570px]">
              ...
              <p className="text__para">Are you in need of a doctor's appointment?
               Look no further! Our user-friendly platform is designed to help you conveniently schedule and manage your medical appointments from the comfort of your own home.
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 lg:gap-[30px] mt-[30px] lg:mt-[55px]">
          ...
          <div className="py-[30px] px-5">
            ...
            <div className="mt-[30px]">
              ...
              <Link to='/doctors' className="w-[44px] h-[44px] rounded-full border border-solid border-[#181A1E] mt-[30px] mx-auto flex items-center justify-center
    ...
    <section>
      <div className="container">
        <div className="xl:w-[470px] mx-auto ">
          ...
          <p className="text__para  text-center">To Exceed Our Customers Expectations By Caring For Them, 
          Seeing Others As Friends And Using Staff Empowerment Devices. </p>
        </div>
        ...
        <div className="flex items-center justify-between flex-col lg:flex-row">
          ...
          <div className="xl:w-[670px]">
            ...
            <ul className="pl-4">
              ...
              <li className="text__para">
                2. Search for your physician here, and contact their clinic. 
              </li>
              <li className="text__para">
          ...
          <div className="relative z-10 xl:w-[770px] flex justify-end mt-[50px] lg:mt-0">
            ...
            md:left-5 z-20 p-2 pb-3 lg:pt-4 lg:px-4 lg:pb-[26px] rounded-[10px]">
              ...
              <div className="flex items-center gap-[6px] lg:gap-[10px] mt-2 lg:mt-[18px]">
                ...
                text-headingColor">Alex John</h4>
              </div>
            </div>
          </div>
        </div>
    ...
    <section>
      <div className="container">
        <div className="xl:w-[470px] mx-auto ">
          ...
          <p className="text__para  text-center">To Exceed Our Customers Expectations By Caring For Them, 
          Seeing Others As Friends And Using Staff Empowerment Devices. 
          </p>
        </div>
